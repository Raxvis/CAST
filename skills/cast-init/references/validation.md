...
5. **Verify YAML frontmatter on every agent file**:
   ...
   - Model is `inherit` (default) or an explicit pin the user approved (e.g. `claude-opus-4-8`, `claude-opus-4-7`, `claude-opus-4-6`, or `claude-haiku-4-5` on a utility agent)
