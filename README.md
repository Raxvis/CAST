...
![Template version](https://img.shields.io/badge/template-v1.2.1-blue)
...
Current template version: `v1.2.1` — see [`CHANGELOG.md`](CHANGELOG.md) for the version history and migration notes.
